export const incomeUiCategories = [
  { category: 'salary', icon: 'fas fa-hand-holding-usd', iconStyle: 'blue' },
  { category: 'investments', icon: 'fas fa-chart-line', iconStyle: '#008051' },
  { category: 'real estate', icon: 'fas fa-building', iconStyle: '#ffbc00' },
  {
